...
namespace Mwp.AzureKeyRotation.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. update AzureKeyRotationDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AzureKeyRotationEfCoreEntityExtensionMappings to extend the IdentityUser entity
